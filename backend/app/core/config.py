...
_DB_NAME = os.getenv("DB_NAME", "buffr_intelligence")
...
class Settings(BaseSettings):
    PROJECT_NAME: str = "Buffr Intelligence API"
    ...
    # default DB credentials and an empty SECRET_KEY are fine on a laptop and
